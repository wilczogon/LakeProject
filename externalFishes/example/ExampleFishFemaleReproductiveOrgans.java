...
import com.edu.agh.student.lakeproject.fish.neuralnetworkbrainfish.*;
...
public class ExampleFishFemaleReproductiveOrgans extends NeuralNetworkBrainFishFemaleReproductiveOrgans{
  
  public ExampleFishFemaleReproductiveOrgans(LakeWorld lakeWorld, Fish ownerFish){
  ...
  public void cross(Chromosome chromosome){
    ...
    super.children.add(new ExampleFish(super.lakeWorld, mWeights, new Vec2((float)(ownerFish.getPosition().x+10*Math.cos(angle)), (float)(ownerFish.getPosition().y+10*Math.sin(angle)))));
  }
}
